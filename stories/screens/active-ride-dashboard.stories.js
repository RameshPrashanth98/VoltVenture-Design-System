...
export const Default = () => `<div style="width:393px;min-height:852px;display:flex;flex-direction:column;background:${tokens.colorSurfaceBase};box-sizing:border-box;">
  ...
  <div style="flex-shrink:0;height:460px;position:relative;background:#e8e8e8;overflow:hidden;">
    ...
    <div style="position:absolute;top:120px;left:50px;width:290px;height:260px;border-radius:50%;border:2px solid ${tokens.colorGrey300};background:transparent;"></div>
    ...
    <!-- Destination Flag -->
    <div style="position:absolute;top:188px;left:302px;font-size:20px;">&#x1F3C1;</div>
    <!-- Location Pulse: 34x34px ring + 16x16px dot -->
    <div style="position:absolute;top:352px;left:180px;width:34px;height:34px;border-radius:50%;background:rgba(198,255,45,0.20);display:flex;align-items:center;justify-content:center;">
      <div style="width:16px;height:16px;border-radius:50%;background:${tokens.colorActionPrimary};"></div>
    </div>
    <!-- Map Fade Bottom -->
    ...
    <!-- Status Bar -->
    <div style="position:absolute;top:0;width:393px;height:62px;background:rgba(255,255,255,0.90);display:flex;align-items:center;justify-content:space-between;padding:0 16px;box-sizing:border-box;">
    ...
    <div style="position:absolute;top:72px;left:20px;width:210px;height:52px;background:${tokens.colorSurfaceBase};border-radius:${tokens.radiusMd}px;box-shadow:${shadowFromToken(tokens.elevationFloating)};display:flex;align-items:center;padding:0 10px;gap:8px;box-sizing:border-box;">
      ...
      <div>
        ...
        <div style="font-family:'${tokens.typeBodyMd.fontFamily}',sans-serif;font-size:${tokens.typeBodyMd.fontSize}px;color:${tokens.colorTextPrimary};font-weight:600;">Victoria Embankment</div>
      </div>
    </div>
    <!-- Safe Zone Warning Chip -->
    <div style="position:absolute;top:133px;left:20px;display:flex;align-items:center;gap:6px;background:${tokens.colorSurfaceBase};border-radius:${tokens.radiusFull}px;padding:4px 10px;box-shadow:${shadowFromToken(tokens.elevationRaised)};">
  ...
  <div style="flex:1;background:${tokens.colorSurfaceBase};display:flex;flex-direction:column;">
    ...
    <!-- Timer Row -->
    <div style="height:48px;display:flex;align-items:center;padding:0 16px;gap:8px;flex-shrink:0;box-sizing:border-box;">
      <span style="font-size:16px;color:${tokens.colorGrey500};">&#x23F1;</span>
      <span style="font-family:'${tokens.typeBodyMd.fontFamily}',sans-serif;font-size:${tokens.typeBodyMd.fontSize}px;font-weight:600;color:${tokens.colorTextPrimary};">00:23:41</span>
      ...
      <div style="display:flex;align-items:center;gap:4px;background:${tokens.colorActionPrimary};border-radius:${tokens.radiusFull}px;padding:4px 10px;">
        ...
        <span style="font-family:'${tokens.typeLabelSm.fontFamily}',sans-serif;font-size:${tokens.typeLabelSm.fontSize}px;font-weight:700;color:${tokens.colorTextPrimary};">LIVE</span>
      </div>
    </div>
    ...
    <div style="height:110px;display:flex;align-items:center;flex-shrink:0;">
      <div style="flex:1;text-align:center;">
        <div style="font-size:40px;font-weight:700;color:${tokens.colorTextPrimary};line-height:1;">18</div>
      ...
      <div style="flex:1;text-align:center;">
        <div style="font-size:40px;font-weight:700;color:${tokens.colorTextPrimary};line-height:1;">12.4</div>
    ...
    <div style="height:1px;background:${tokens.colorGrey100};flex-shrink:0;"></div>
    <!-- Billing Section -->
    <div style="padding:12px 16px;display:flex;flex-direction:column;gap:6px;flex-shrink:0;">
      ...
      <div style="display:flex;align-items:center;justify-content:space-between;">
        <span style="font-family:'${tokens.typeBodyMd.fontFamily}',sans-serif;font-size:${tokens.typeBodyMd.fontSize}px;font-weight:700;color:${tokens.colorTextPrimary};">Total</span>
        <span style="font-family:'${tokens.typeBodyMd.fontFamily}',sans-serif;font-size:${tokens.typeBodyMd.fontSize}px;font-weight:700;color:${tokens.colorTextPrimary};">&#x20B9; 58.75</span>
      </div>
    </div>
    <div style="height:1px;background:${tokens.colorGrey100};flex-shrink:0;"></div>
    <!-- Action Row: SOS #EF4444 brand exception / End Ride colorActionPrimary -->
    <div style="padding:12px 16px;display:flex;gap:12px;flex-shrink:0;">
      <button style="width:80px;height:56px;background:#EF4444;border-radius:${tokens.radiusMd}px;border:none;color:#ffffff;font-family:'${tokens.typeBodyMd.fontFamily}',sans-serif;font-size:${tokens.typeBodyMd.fontSize}px;font-weight:700;cursor:pointer;">SOS</button>
      <button style="flex:1;height:56px;background:${tokens.colorActionPrimary};border-radius:${tokens.radiusMd}px;border:none;font-family:'${tokens.typeHeadingSm.fontFamily}',sans-serif;font-size:${tokens.typeHeadingSm.fontSize}px;font-weight:600;color:${tokens.colorTextPrimary};cursor:pointer;">End Ride</button>
    </div>
  </div>
  <!-- Tab Bar: Ride active -->
  <div style="flex-shrink:0;background:${tokens.colorSurfaceBase};height:56px;display:flex;align-items:center;padding:0 16px;box-sizing:border-box;box-shadow:${shadowFromToken(tokens.elevationFloating)};">${tabsHtml('Ride')}</div>
</div>`;
...
export const Interactive = () => {
  ...
  sz.style.cssText = `position:absolute;top:120px;left:50px;width:290px;height:260px;border-radius:50%;border:2px solid ${tokens.colorGrey300};background:transparent;`;
  ...
  flagPin.style.cssText = 'position:absolute;top:188px;left:302px;font-size:20px;';
  flagPin.textContent = '\uD83C\uDFC1';
  mapArea.appendChild(flagPin);

  const pulse = document.createElement('div');
  pulse.style.cssText = 'position:absolute;top:352px;left:180px;width:34px;height:34px;border-radius:50%;background:rgba(198,255,45,0.20);display:flex;align-items:center;justify-content:center;animation:locationPulse 2s ease-in-out infinite;';
  const dot = document.createElement('div');
  dot.style.cssText = `width:16px;height:16px;border-radius:50%;background:${tokens.colorActionPrimary};`;
  ...
  sb.style.cssText = 'position:absolute;top:0;width:393px;height:62px;background:rgba(255,255,255,0.90);display:flex;align-items:center;justify-content:space-between;padding:0 16px;box-sizing:border-box;';
  ...
  navCard.style.cssText = `position:absolute;top:72px;left:20px;width:210px;height:52px;background:${tokens.colorSurfaceBase};border-radius:${tokens.radiusMd}px;box-shadow:${shadowFromToken(tokens.elevationFloating)};display:flex;align-items:center;padding:0 10px;gap:8px;box-sizing:border-box;cursor:pointer;transition:opacity 0.3s;`;
  navCard.innerHTML = `<div style="width:32px;height:32px;background:${tokens.colorGrey100};border-radius:${tokens.radiusFull}px;display:flex;align-items:center;justify-content:center;font-size:14px;">&#x2192;</div><div><div style="font-family:'${tokens.typeLabelSm.fontFamily}',sans-serif;font-size:${tokens.typeLabelSm.fontSize}px;color:${tokens.colorGrey500};">Continue on</div><div style="font-family:'${tokens.typeBodyMd.fontFamily}',sans-serif;font-size:${tokens.typeBodyMd.fontSize}px;color:${tokens.colorTextPrimary};font-weight:600;">Victoria Embankment</div></div>`;
  ...
  szWarn.style.cssText = `position:absolute;top:133px;left:20px;display:flex;align-items:center;gap:6px;background:${tokens.colorSurfaceBase};border-radius:${tokens.radiusFull}px;padding:4px 10px;box-shadow:${shadowFromToken(tokens.elevationRaised)};`;
  ...
  timerRow.innerHTML = `<span style="font-size:16px;color:${tokens.colorGrey500};">&#x23F1;</span><span style="font-family:Inter,sans-serif;font-size:${tokens.typeBodyMd.fontSize}px;font-weight:600;color:${tokens.colorTextPrimary};">00:23:41</span><div style="flex:1;"></div><div style="display:flex;align-items:center;gap:4px;background:${tokens.colorActionPrimary};border-radius:${tokens.radiusFull}px;padding:4px 10px;"><div style="width:6px;height:6px;background:${tokens.colorTextPrimary};border-radius:50%;"></div><span style="font-family:Inter,sans-serif;font-size:${tokens.typeLabelSm.fontSize}px;font-weight:700;color:${tokens.colorTextPrimary};">LIVE</span></div>`;
  ...
  actionRow.style.cssText = 'padding:12px 16px;display:flex;gap:12px;flex-shrink:0;';

  // SOS: #EF4444 — brand exception, no VV token
  const sosBtn = document.createElement('button');
  sosBtn.style.cssText = `width:80px;height:56px;background:#EF4444;border-radius:${tokens.radiusMd}px;border:none;cursor:pointer;font-family:Inter,sans-serif;font-size:${tokens.typeBodyMd.fontSize}px;font-weight:700;color:#ffffff;`;
  ...
  endBtn.style.cssText = `flex:1;height:56px;background:${tokens.colorActionPrimary};border-radius:${tokens.radiusMd}px;border:none;cursor:pointer;font-family:Inter,sans-serif;font-size:${tokens.typeHeadingSm.fontSize}px;font-weight:600;color:${tokens.colorTextPrimary};`;
