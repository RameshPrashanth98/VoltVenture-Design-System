...
export const Interactive = () => {
  ...
  dot1.style.cssText = 'width:24px;height:8px;border-radius:4px;background:var(--vv-color-surface-inverse);flex-shrink:0';
