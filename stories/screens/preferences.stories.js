...
export const Default = () => `
  ...
  ">
    ...
    <div style="height:44px;display:flex;align-items:center;padding:0 16px;gap:12px;flex-shrink:0;">
      ...
      <span style="font-size:${tokens.fontSizeHeadingMd}px;font-weight:700;color:${tokens.colorTextPrimary};">Preferences</span>
    </div>
    <!-- REGIONAL Section -->
    <div style="margin:16px 16px 0;">
      <div style="font-size:${tokens.fontSizeLabelSm}px;font-weight:${tokens.fontWeightLabelSm};color:${tokens.colorGrey500};text-transform:uppercase;letter-spacing:0.5px;margin-bottom:8px;">REGIONAL</div>
      <div style="background:${tokens.colorSurfaceBase};border-radius:${tokens.radiusLg}px;overflow:hidden;">
        ...
        <div style="display:flex;align-items:center;min-height:48px;padding:12px 16px;gap:12px;cursor:pointer;box-sizing:border-box;">
          ...
          <span style="flex:1;font-size:${tokens.fontSizeBodyMd}px;font-weight:600;color:${tokens.colorTextPrimary};">Language</span>
        ...
        <div style="display:flex;align-items:center;min-height:48px;padding:12px 16px;gap:12px;box-sizing:border-box;">
          <div style="width:30px;height:30px;background:${tokens.colorGrey100};border-radius:${tokens.radiusSm}px;display:flex;align-items:center;justify-content:center;font-size:15px;flex-shrink:0;">&#128207;</div>
          <span style="flex:1;font-size:${tokens.fontSizeBodyMd}px;font-weight:600;color:${tokens.colorTextPrimary};">Distance Units</span>
          <div style="display:inline-flex;background:${tokens.colorGrey100};border-radius:${tokens.radiusFull}px;padding:3px;gap:3px;">
            <div style="background:${tokens.colorSurfaceInverse};color:#ffffff;border-radius:${tokens.radiusFull}px;padding:4px 14px;font-size:${tokens.fontSizeLabelSm}px;font-weight:${tokens.fontWeightLabelSm};cursor:pointer;">km</div>
            <div style="background:transparent;color:${tokens.colorTextSecondary};border-radius:${tokens.radiusFull}px;padding:4px 14px;font-size:${tokens.fontSizeLabelSm}px;font-weight:${tokens.fontWeightLabelSm};cursor:pointer;">mi</div>
          </div>
        </div>
        <div style="height:1px;background:${tokens.colorGrey100};"></div>
        <!-- Currency Row -->
        <div style="display:flex;align-items:center;min-height:48px;padding:12px 16px;gap:12px;cursor:pointer;box-sizing:border-box;">
          <div style="width:30px;height:30px;background:${tokens.colorGrey100};border-radius:${tokens.radiusSm}px;display:flex;align-items:center;justify-content:center;font-size:15px;flex-shrink:0;">&#128178;</div>
          <span style="flex:1;font-size:${tokens.fontSizeBodyMd}px;font-weight:600;color:${tokens.colorTextPrimary};">Currency</span>
    ...
    <div style="margin:16px 16px 0;">
      <div style="font-size:${tokens.fontSizeLabelSm}px;font-weight:${tokens.fontWeightLabelSm};color:${tokens.colorGrey500};text-transform:uppercase;letter-spacing:0.5px;margin-bottom:8px;">NOTIFICATIONS</div>
      <div style="background:${tokens.colorSurfaceBase};border-radius:${tokens.radiusLg}px;overflow:hidden;">
        <div style="display:flex;align-items:center;padding:12px 16px;gap:12px;box-sizing:border-box;">
          <div style="width:30px;height:30px;background:${tokens.colorGrey100};border-radius:${tokens.radiusSm}px;display:flex;align-items:center;justify-content:center;font-size:15px;flex-shrink:0;">&#128276;</div>
          <div style="flex:1;">
            <div style="font-size:${tokens.fontSizeBodyMd}px;font-weight:600;color:${tokens.colorTextPrimary};">Push Notifications</div>
            <div style="font-size:${tokens.fontSizeLabelSm}px;font-weight:${tokens.fontWeightLabelSm};color:${tokens.colorTextSecondary};margin-top:2px;">Ride updates &amp; promotions</div>
          </div>
          <!-- Toggle pill (50x29px ON state) -->
          <div style="width:50px;height:29px;background:${tokens.colorActionPrimary};border-radius:${tokens.radiusFull}px;position:relative;display:inline-flex;align-items:center;padding:0 4px;box-sizing:border-box;flex-shrink:0;cursor:pointer;">
            <div style="width:21px;height:21px;background:#ffffff;border-radius:50%;position:absolute;right:4px;transition:right 150ms ease;"></div>
          </div>
        </div>
      </div>
    </div>
...
export const Interactive = () => {
  ...
  regWrap.style.cssText = 'margin:16px 16px 0;';
  const regLbl = document.createElement('div');
  regLbl.style.cssText = `font-family:Inter,sans-serif;font-size:${tokens.fontSizeLabelSm}px;font-weight:${tokens.fontWeightLabelSm};color:${tokens.colorGrey500};text-transform:uppercase;letter-spacing:0.5px;margin-bottom:8px;`;
  ...
  langRow.style.cssText = `display:flex;align-items:center;min-height:48px;padding:12px 16px;gap:12px;cursor:pointer;box-sizing:border-box;`;
  ...
  langChip.style.cssText = `width:30px;height:30px;background:${tokens.colorGrey100};border-radius:${tokens.radiusSm}px;display:flex;align-items:center;justify-content:center;font-size:15px;flex-shrink:0;`;
  langChip.textContent = '\uD83C\uDF10';
  const langText = document.createElement('span');
  langText.style.cssText = `flex:1;font-family:Inter,sans-serif;font-size:${tokens.fontSizeBodyMd}px;font-weight:600;color:${tokens.colorTextPrimary};`;
  ...
  distRow.style.cssText = `display:flex;align-items:center;min-height:48px;padding:12px 16px;gap:12px;box-sizing:border-box;`;
  const distChip = document.createElement('div');
  distChip.style.cssText = `width:30px;height:30px;background:${tokens.colorGrey100};border-radius:${tokens.radiusSm}px;display:flex;align-items:center;justify-content:center;font-size:15px;flex-shrink:0;`;
  distChip.textContent = '\uD83D\uDCCF';
  const distText = document.createElement('span');
  distText.style.cssText = `flex:1;font-family:Inter,sans-serif;font-size:${tokens.fontSizeBodyMd}px;font-weight:600;color:${tokens.colorTextPrimary};`;
  ...
  kmBtn.style.cssText = `background:${tokens.colorSurfaceInverse};color:#ffffff;border-radius:${tokens.radiusFull}px;padding:4px 14px;font-family:Inter,sans-serif;font-size:${tokens.fontSizeLabelSm}px;font-weight:${tokens.fontWeightLabelSm};cursor:pointer;`;
  kmBtn.textContent = 'km';

  const miBtn = document.createElement('div');
  miBtn.style.cssText = `background:transparent;color:${tokens.colorTextSecondary};border-radius:${tokens.radiusFull}px;padding:4px 14px;font-family:Inter,sans-serif;font-size:${tokens.fontSizeLabelSm}px;font-weight:${tokens.fontWeightLabelSm};cursor:pointer;`;
  miBtn.textContent = 'mi';

  function updateSegmented() {
    if (activeUnit === 'km') {
      kmBtn.style.background = tokens.colorSurfaceInverse;
      kmBtn.style.color = '#ffffff';
  ...
  currRow.style.cssText = `display:flex;align-items:center;min-height:48px;padding:12px 16px;gap:12px;cursor:pointer;box-sizing:border-box;`;
  ...
  currChip.style.cssText = `width:30px;height:30px;background:${tokens.colorGrey100};border-radius:${tokens.radiusSm}px;display:flex;align-items:center;justify-content:center;font-size:15px;flex-shrink:0;`;
  currChip.textContent = '\uD83D\uDCB2';
  const currText = document.createElement('span');
  currText.style.cssText = `flex:1;font-family:Inter,sans-serif;font-size:${tokens.fontSizeBodyMd}px;font-weight:600;color:${tokens.colorTextPrimary};`;
  ...
  notifWrap.style.cssText = 'margin:16px 16px 0;';
  const notifLbl = document.createElement('div');
  notifLbl.style.cssText = `font-family:Inter,sans-serif;font-size:${tokens.fontSizeLabelSm}px;font-weight:${tokens.fontWeightLabelSm};color:${tokens.colorGrey500};text-transform:uppercase;letter-spacing:0.5px;margin-bottom:8px;`;
  ...
  pushRow.style.cssText = `display:flex;align-items:center;padding:12px 16px;gap:12px;box-sizing:border-box;`;
  const pushChip = document.createElement('div');
  pushChip.style.cssText = `width:30px;height:30px;background:${tokens.colorGrey100};border-radius:${tokens.radiusSm}px;display:flex;align-items:center;justify-content:center;font-size:15px;flex-shrink:0;`;
  ...
  pushTitle.style.cssText = `font-family:Inter,sans-serif;font-size:${tokens.fontSizeBodyMd}px;font-weight:600;color:${tokens.colorTextPrimary};`;
  pushTitle.textContent = 'Push Notifications';
  const pushSub = document.createElement('div');
  pushSub.style.cssText = `font-family:Inter,sans-serif;font-size:${tokens.fontSizeLabelSm}px;font-weight:${tokens.fontWeightLabelSm};color:${tokens.colorTextSecondary};margin-top:2px;`;
  ...
  notifPill.style.cssText = `width:50px;height:29px;background:${tokens.colorActionPrimary};border-radius:${tokens.radiusFull}px;position:relative;display:inline-flex;align-items:center;padding:0 4px;box-sizing:border-box;flex-shrink:0;cursor:pointer;`;
  const notifKnob = document.createElement('div');
  notifKnob.style.cssText = 'width:21px;height:21px;background:#ffffff;border-radius:50%;position:absolute;right:4px;transition:right 150ms ease;';
...
export const SourceCode = () =>
  ...
  `<div style="margin:0 0 20px;font-family:'JetBrains Mono',monospace;font-size:13px;font-weight:600;color:#c6ff2d">// Preferences — React Native Paper</div>` +
