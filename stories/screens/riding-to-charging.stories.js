...
export const Default = () => `<div style="width:393px;height:852px;position:relative;overflow:hidden;background:#e8e8e8;box-sizing:border-box;">
  ...
  <!-- Location Pulse -->
  <div style="position:absolute;top:380px;left:182px;width:30px;height:30px;border-radius:var(--vv-radius-full);background:rgba(198,255,45,0.20);display:flex;align-items:center;justify-content:center;">
  ...
  <!-- Cancel Button -->
  <div style="position:absolute;top:72px;right:20px;width:40px;height:40px;background:${tokens.colorSurfaceBase};border-radius:var(--vv-radius-full);display:flex;align-items:center;justify-content:center;box-shadow:${shadowFromToken(tokens.elevationFloating)};cursor:pointer;font-size:16px;">&#x2715;</div>
  <!-- Turn Instruction Card: 264x52px -->
  <div style="position:absolute;top:80px;left:20px;width:264px;height:52px;background:${tokens.colorSurfaceBase};border-radius:${tokens.radiusMd}px;box-shadow:${shadowFromToken(tokens.elevationFloating)};display:flex;align-items:center;padding:0 10px;gap:var(--vv-space-3);box-sizing:border-box;">
    ...
    <div>
      ...
      <div style="font-family:'${tokens.typeBodyMd.fontFamily}',sans-serif;font-size:${tokens.typeBodyMd.fontSize}px;color:${tokens.colorTextPrimary};font-weight:var(--ds-font-weight-heading);">VoltHub Central</div>
    </div>
  </div>
  <!-- Recenter FAB -->
  <div style="position:absolute;bottom:198px;right:20px;width:48px;height:48px;background:${tokens.colorSurfaceBase};border-radius:var(--vv-radius-full);box-shadow:${shadowFromToken(tokens.elevationFloating)};display:flex;align-items:center;justify-content:center;font-size:18px;cursor:pointer;">&#x29BF;</div>
  <!-- Top Gradient -->
  ...
  <div style="position:absolute;bottom:88px;left:20px;right:20px;background:${tokens.colorSurfaceBase};border-radius:${tokens.radiusLg}px;padding:var(--vv-space-5);box-shadow:${shadowFromToken(tokens.elevationFloating)};box-sizing:border-box;">
    ...
    <div style="display:flex;align-items:center;gap:var(--vv-space-4);margin-bottom:var(--vv-space-4);">
      <div style="flex:1;">
        <div style="font-size:24px;font-weight:var(--ds-font-weight-display);color:${tokens.colorTextPrimary};line-height:1;">1.2 km</div>
      ...
      <div style="flex:1;">
        <div style="font-size:24px;font-weight:var(--ds-font-weight-display);color:${tokens.colorTextPrimary};line-height:1;">8 min</div>
      ...
      <div style="flex:1;display:flex;justify-content:flex-end;">
        <div style="background:${tokens.colorGreen100};border-radius:${tokens.radiusFull}px;padding:var(--vv-space-2) 10px;font-family:'${tokens.typeLabelSm.fontFamily}',sans-serif;font-size:${tokens.typeLabelSm.fontSize}px;color:${tokens.colorTextAccent};">&#x26A1; VV-4829</div>
      </div>
    </div>
    <div style="height:1px;background:${tokens.colorGrey100};margin-bottom:var(--vv-space-4);"></div>
    <button style="width:100%;height:48px;background:${tokens.colorActionPrimary};border:none;border-radius:${tokens.radiusFull}px;font-family:'${tokens.typeHeadingSm.fontFamily}',sans-serif;font-size:${tokens.typeHeadingSm.fontSize}px;font-weight:var(--ds-font-weight-heading);color:${tokens.colorTextPrimary};cursor:pointer;">I&#x2019;ve Docked &#x2192;</button>
    <div style="text-align:center;margin-top:var(--vv-space-3);font-family:'${tokens.typeLabelSm.fontFamily}',sans-serif;font-size:${tokens.typeLabelSm.fontSize}px;color:${tokens.colorTextSecondary};cursor:pointer;">Resume Ride</div>
  </div>
  <!-- Tab Bar -->
...
export const Interactive = () => {
  ...
  pulse.style.cssText = 'position:absolute;top:380px;left:182px;width:30px;height:30px;border-radius:var(--vv-radius-full);background:rgba(198,255,45,0.20);display:flex;align-items:center;justify-content:center;';
  ...
  cancelBtn.style.cssText = `position:absolute;top:72px;right:20px;width:40px;height:40px;background:${tokens.colorSurfaceBase};border-radius:var(--vv-radius-full);display:flex;align-items:center;justify-content:center;box-shadow:${shadowFromToken(tokens.elevationFloating)};cursor:pointer;font-size:16px;`;
  cancelBtn.textContent = '\u2715';
  screen.appendChild(cancelBtn);

  // Turn Instruction Card
  const turnCard = document.createElement('div');
  turnCard.style.cssText = `position:absolute;top:80px;left:20px;width:264px;height:52px;background:${tokens.colorSurfaceBase};border-radius:${tokens.radiusMd}px;box-shadow:${shadowFromToken(tokens.elevationFloating)};display:flex;align-items:center;padding:0 10px;gap:var(--vv-space-3);box-sizing:border-box;`;
  turnCard.innerHTML = `<div style="width:36px;height:36px;background:${tokens.colorGrey100};border-radius:${tokens.radiusFull}px;display:flex;align-items:center;justify-content:center;font-size:16px;">&#x27B6;</div><div><div style="font-family:Inter,sans-serif;font-size:${tokens.typeLabelSm.fontSize}px;color:${tokens.colorGrey500};">Head towards</div><div style="font-family:Inter,sans-serif;font-size:${tokens.typeBodyMd.fontSize}px;color:${tokens.colorTextPrimary};font-weight:var(--ds-font-weight-heading);">VoltHub Central</div></div>`;
  screen.appendChild(turnCard);

  // Recenter FAB
  const recenter = document.createElement('div');
  recenter.style.cssText = `position:absolute;bottom:198px;right:20px;width:48px;height:48px;background:${tokens.colorSurfaceBase};border-radius:var(--vv-radius-full);box-shadow:${shadowFromToken(tokens.elevationFloating)};display:flex;align-items:center;justify-content:center;font-size:18px;cursor:pointer;`;
  ...
  resumeLink.style.cssText = `text-align:center;margin-top:var(--vv-space-3);font-family:Inter,sans-serif;font-size:${tokens.typeLabelSm.fontSize}px;color:${tokens.colorTextSecondary};cursor:pointer;`;
