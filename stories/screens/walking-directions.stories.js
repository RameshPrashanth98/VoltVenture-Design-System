...
export const Default = () => `<div style="width:393px;min-height:852px;position:relative;overflow:hidden;background:#e8e8e8;box-sizing:border-box;">
  ...
  <div style="position:absolute;top:432px;left:182px;width:30px;height:30px;border-radius:var(--vv-radius-full);background:rgba(198,255,45,0.20);display:flex;align-items:center;justify-content:center;"><div style="width:14px;height:14px;border-radius:var(--vv-radius-full);background:${tokens.colorActionPrimary};"></div></div>
  ...
  <div style="position:absolute;top:72px;right:20px;width:40px;height:40px;background:${tokens.colorSurfaceBase};border-radius:var(--vv-radius-full);box-shadow:${shadowFromToken(tokens.elevationFloating)};display:flex;align-items:center;justify-content:center;font-size:16px;color:${tokens.colorTextPrimary};">&#x2715;</div>
  <div style="position:absolute;top:80px;left:20px;width:264px;height:52px;background:${tokens.colorSurfaceBase};border-radius:${tokens.radiusMd}px;box-shadow:${shadowFromToken(tokens.elevationFloating)};display:flex;align-items:center;padding:0 var(--vv-space-4);gap:10px;box-sizing:border-box;">
    ...
    <div style="flex:1;">
      ...
      <div style="font-family:'${tokens.typeBodyMd.fontFamily}',sans-serif;font-size:${tokens.typeBodyMd.fontSize}px;color:${tokens.colorTextPrimary};font-weight:var(--ds-font-weight-heading);">Marine Drive</div>
    </div>
  </div>
  <div style="position:absolute;bottom:198px;right:20px;width:48px;height:48px;background:${tokens.colorSurfaceBase};border-radius:var(--vv-radius-full);box-shadow:${shadowFromToken(tokens.elevationFloating)};display:flex;align-items:center;justify-content:center;font-size:var(--vv-text-heading-lg-size);color:${tokens.colorTextPrimary};">&#x2299;</div>
  <div style="position:absolute;bottom:88px;left:20px;right:20px;background:${tokens.colorSurfaceBase};border-radius:${tokens.radiusLg}px;padding:var(--vv-space-5);box-shadow:${shadowFromToken(tokens.elevationFloating)};box-sizing:border-box;">
    <div style="display:flex;align-items:center;gap:var(--vv-space-3);margin-bottom:var(--vv-space-4);">
      <div style="flex:1;text-align:center;">
        <div style="font-family:'${tokens.typeHeadingSm.fontFamily}',sans-serif;font-size:${tokens.typeHeadingSm.fontSize}px;font-weight:var(--ds-font-weight-display);color:${tokens.colorTextPrimary};">0.3 km</div>
      ...
      <div style="flex:1;text-align:center;">
        <div style="font-family:'${tokens.typeHeadingSm.fontFamily}',sans-serif;font-size:${tokens.typeHeadingSm.fontSize}px;font-weight:var(--ds-font-weight-display);color:${tokens.colorTextPrimary};">4 min</div>
      ...
      <div style="flex:1;display:flex;justify-content:flex-end;">
        <div style="background:${tokens.colorGreen100};border-radius:${tokens.radiusFull}px;padding:var(--vv-space-2) var(--vv-space-3);font-family:'${tokens.typeLabelSm.fontFamily}',sans-serif;font-size:${tokens.typeLabelSm.fontSize}px;color:${tokens.colorTextAccent};">&#x1F6B2; VV-4829</div>
      </div>
    </div>
    <div style="height:1px;background:${tokens.colorGrey100};"></div>
    <button style="margin-top:var(--vv-space-4);height:48px;width:100%;background:${tokens.colorActionPrimary};border:none;border-radius:${tokens.radiusFull}px;font-family:'${tokens.typeHeadingSm.fontFamily}',sans-serif;font-size:${tokens.typeHeadingSm.fontSize}px;font-weight:var(--ds-font-weight-heading);color:${tokens.colorTextPrimary};cursor:pointer;">I&#x27;ve Arrived &#x2192;</button>
    <div style="text-align:center;margin-top:var(--vv-space-3);font-family:'${tokens.typeLabelSm.fontFamily}',sans-serif;font-size:${tokens.typeLabelSm.fontSize}px;color:${tokens.colorTextSecondary};cursor:pointer;">Cancel Navigation</div>
  </div>
...
export const Interactive = () => {
  ...
  pulse.style.cssText = 'position:absolute;top:432px;left:182px;width:30px;height:30px;border-radius:var(--vv-radius-full);background:rgba(198,255,45,0.20);display:flex;align-items:center;justify-content:center;animation:locationPulse 2s ease-in-out infinite;';
  ...
  cancelBtn.style.cssText = `position:absolute;top:72px;right:20px;width:40px;height:40px;background:${tokens.colorSurfaceBase};border-radius:var(--vv-radius-full);box-shadow:${shadowFromToken(tokens.elevationFloating)};display:flex;align-items:center;justify-content:center;font-size:16px;cursor:pointer;`;
  cancelBtn.textContent = '✕';
  screen.appendChild(cancelBtn);

  // Turn Instruction Card (264×52px)
  const turnCard = document.createElement('div');
  turnCard.style.cssText = `position:absolute;top:80px;left:20px;width:264px;height:52px;background:${tokens.colorSurfaceBase};border-radius:${tokens.radiusMd}px;box-shadow:${shadowFromToken(tokens.elevationFloating)};display:flex;align-items:center;padding:0 var(--vv-space-4);gap:10px;box-sizing:border-box;`;
  turnCard.innerHTML = `<div style="width:36px;height:36px;background:${tokens.colorGrey100};border-radius:${tokens.radiusSm}px;display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:18px;">&#x27F5;</div><div style="flex:1;"><div style="font-family:'${tokens.typeLabelSm.fontFamily}',sans-serif;font-size:${tokens.typeLabelSm.fontSize}px;color:${tokens.colorGrey500};">Turn left onto</div><div style="font-family:'${tokens.typeBodyMd.fontFamily}',sans-serif;font-size:${tokens.typeBodyMd.fontSize}px;color:${tokens.colorTextPrimary};font-weight:var(--ds-font-weight-heading);">Marine Drive</div></div>`;
  screen.appendChild(turnCard);

  const recenterFab = document.createElement('div');
  recenterFab.style.cssText = `position:absolute;bottom:198px;right:20px;width:48px;height:48px;background:${tokens.colorSurfaceBase};border-radius:var(--vv-radius-full);box-shadow:${shadowFromToken(tokens.elevationFloating)};display:flex;align-items:center;justify-content:center;font-size:var(--vv-text-heading-lg-size);cursor:pointer;`;
  ...
  progressCard.style.cssText = `position:absolute;bottom:88px;left:20px;right:20px;background:${tokens.colorSurfaceBase};border-radius:${tokens.radiusLg}px;padding:var(--vv-space-5);box-shadow:${shadowFromToken(tokens.elevationFloating)};box-sizing:border-box;`;
  const progressRow = document.createElement('div');
  progressRow.style.cssText = 'display:flex;align-items:center;gap:var(--vv-space-3);margin-bottom:var(--vv-space-4);';
  progressRow.innerHTML = `<div style="flex:1;text-align:center;"><div style="font-family:'${tokens.typeHeadingSm.fontFamily}',sans-serif;font-size:${tokens.typeHeadingSm.fontSize}px;font-weight:var(--ds-font-weight-display);color:${tokens.colorTextPrimary};">0.3 km</div><div style="font-family:'${tokens.typeLabelSm.fontFamily}',sans-serif;font-size:${tokens.typeLabelSm.fontSize}px;color:${tokens.colorGrey500};">left</div></div><div style="width:1px;height:32px;background:${tokens.colorGrey200};"></div><div style="flex:1;text-align:center;"><div style="font-family:'${tokens.typeHeadingSm.fontFamily}',sans-serif;font-size:${tokens.typeHeadingSm.fontSize}px;font-weight:var(--ds-font-weight-display);color:${tokens.colorTextPrimary};">4 min</div><div style="font-family:'${tokens.typeLabelSm.fontFamily}',sans-serif;font-size:${tokens.typeLabelSm.fontSize}px;color:${tokens.colorGrey500};">ETA</div></div><div style="flex:1;display:flex;justify-content:flex-end;"><div style="background:${tokens.colorGreen100};border-radius:${tokens.radiusFull}px;padding:var(--vv-space-2) var(--vv-space-3);font-family:'${tokens.typeLabelSm.fontFamily}',sans-serif;font-size:${tokens.typeLabelSm.fontSize}px;color:${tokens.colorTextAccent};">&#x1F6B2; VV-4829</div></div>`;
  const divider2 = document.createElement('div');
  divider2.style.cssText = `height:1px;background:${tokens.colorGrey100};`;
  const arrivedBtn = document.createElement('button');
  arrivedBtn.style.cssText = `margin-top:var(--vv-space-4);height:48px;width:100%;background:${tokens.colorActionPrimary};border:none;border-radius:${tokens.radiusFull}px;font-family:'${tokens.typeHeadingSm.fontFamily}',sans-serif;font-size:${tokens.typeHeadingSm.fontSize}px;font-weight:var(--ds-font-weight-heading);color:${tokens.colorTextPrimary};cursor:pointer;transition:transform 0.1s;`;
  ...
  cancelNavLink.style.cssText = `text-align:center;margin-top:var(--vv-space-3);font-family:'${tokens.typeLabelSm.fontFamily}',sans-serif;font-size:${tokens.typeLabelSm.fontSize}px;color:${tokens.colorTextSecondary};cursor:pointer;`;
