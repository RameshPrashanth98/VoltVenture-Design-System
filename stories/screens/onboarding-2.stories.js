...
export const Interactive = () => {
  ...
  dot2.style.cssText = 'width:24px;height:8px;border-radius:4px;background:var(--vv-color-surface-inverse);flex-shrink:0';
  const dot3 = document.createElement('div');
  dot3.style.cssText = 'width:8px;height:8px;border-radius:var(--vv-radius-full);background:var(--vv-color-text-disabled);flex-shrink:0';
