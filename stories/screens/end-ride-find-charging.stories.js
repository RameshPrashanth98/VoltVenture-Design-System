...
export const Default = () => `<div style="width:393px;height:852px;position:relative;overflow:hidden;background:#e8e8e8;box-sizing:border-box;">
  ...
  <div style="position:absolute;top:420px;left:182px;width:30px;height:30px;border-radius:50%;background:rgba(198,255,45,0.20);display:flex;align-items:center;justify-content:center;">
  ...
  <div style="position:absolute;top:200px;left:60px;background:${tokens.colorGrey900};border-radius:${tokens.radiusFull}px;padding:4px 8px;display:inline-flex;align-items:center;gap:4px;">
    <span style="color:${tokens.colorActionPrimary};font-size:12px;">&#x26A1;</span>
    <span style="font-family:'${tokens.typeLabelSm.fontFamily}',sans-serif;font-size:${tokens.typeLabelSm.fontSize}px;color:#ffffff;">VoltHub East</span>
  </div>
  ...
  <!-- Title Banner -->
  <div style="position:absolute;top:72px;left:20px;display:flex;align-items:center;gap:12px;">
    ...
    <div>
      <div style="font-family:'${tokens.typeBodyMd.fontFamily}',sans-serif;font-size:${tokens.typeBodyMd.fontSize}px;font-weight:600;color:${tokens.colorTextPrimary};">Find a Charging Hub</div>
  ...
  <div style="position:absolute;bottom:88px;left:20px;right:20px;background:${tokens.colorSurfaceBase};border-radius:${tokens.radiusLg}px;padding:16px;box-shadow:${shadowFromToken(tokens.elevationFloating)};box-sizing:border-box;">
    ...
    <div style="display:flex;align-items:center;gap:8px;margin-bottom:8px;">
      ...
      <span style="font-family:'${tokens.typeBodyMd.fontFamily}',sans-serif;font-size:${tokens.typeBodyMd.fontSize}px;font-weight:600;color:${tokens.colorTextPrimary};flex:1;">VoltHub Central</span>
    ...
    <!-- Slots Badge -->
    <div style="background:${tokens.colorGreen100};border-radius:${tokens.radiusFull}px;padding:3px 10px;display:inline-flex;margin-bottom:8px;">
    ...
    <div style="height:1px;background:${tokens.colorGrey100};margin-bottom:8px;"></div>
    <!-- Fee Note -->
    <div style="font-family:'${tokens.typeLabelSm.fontFamily}',sans-serif;font-size:${tokens.typeLabelSm.fontSize}px;color:${tokens.colorTextSecondary};margin-bottom:12px;">Free charging &middot; &#x20B9; 10 docking fee after 2 hrs</div>
    <!-- Navigate Button -->
    <button style="width:100%;height:48px;background:${tokens.colorActionPrimary};border:none;border-radius:${tokens.radiusFull}px;font-family:'${tokens.typeHeadingSm.fontFamily}',sans-serif;font-size:${tokens.typeHeadingSm.fontSize}px;font-weight:600;color:${tokens.colorTextPrimary};cursor:pointer;">&#x1F9ED; Navigate to Station</button>
    <!-- Resume Ride Link -->
    <div style="text-align:center;margin-top:8px;font-family:'${tokens.typeLabelSm.fontFamily}',sans-serif;font-size:${tokens.typeLabelSm.fontSize}px;color:${tokens.colorTextSecondary};text-decoration:underline;cursor:pointer;">Resume Ride</div>
  </div>
  <!-- Tab Bar -->
...
export const Interactive = () => {
  ...
  pulse.style.cssText = 'position:absolute;top:420px;left:182px;width:30px;height:30px;border-radius:50%;background:rgba(198,255,45,0.20);display:flex;align-items:center;justify-content:center;';
  ...
  otherPin.style.cssText = `position:absolute;top:200px;left:60px;background:${tokens.colorGrey900};border-radius:${tokens.radiusFull}px;padding:4px 8px;display:inline-flex;align-items:center;gap:4px;`;
  otherPin.innerHTML = `<span style="color:${tokens.colorActionPrimary};font-size:12px;">&#x26A1;</span><span style="font-family:Inter,sans-serif;font-size:${tokens.typeLabelSm.fontSize}px;color:#ffffff;">VoltHub East</span>`;
  ...
  divCard.style.cssText = `height:1px;background:${tokens.colorGrey100};margin-bottom:8px;`;
  card.appendChild(divCard);

  const feeNote = document.createElement('div');
  feeNote.style.cssText = `font-family:Inter,sans-serif;font-size:${tokens.typeLabelSm.fontSize}px;color:${tokens.colorTextSecondary};margin-bottom:12px;`;
  feeNote.textContent = 'Free charging \u00B7 \u20B9 10 docking fee after 2 hrs';
  card.appendChild(feeNote);

  const navBtn = document.createElement('button');
  navBtn.style.cssText = `width:100%;height:48px;background:${tokens.colorActionPrimary};border:none;border-radius:${tokens.radiusFull}px;font-family:Inter,sans-serif;font-size:${tokens.typeHeadingSm.fontSize}px;font-weight:600;color:${tokens.colorTextPrimary};cursor:pointer;`;
  ...
  resumeLink.style.cssText = `text-align:center;margin-top:8px;font-family:Inter,sans-serif;font-size:${tokens.typeLabelSm.fontSize}px;color:${tokens.colorTextSecondary};text-decoration:underline;cursor:pointer;`;
