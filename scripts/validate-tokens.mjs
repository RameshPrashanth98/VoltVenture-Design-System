...
// ===========================================================================
// V1 — Unresolved Reference Check (post-build stub)
//
// This check must run AFTER npm run build:tokens generates output files.
// It checks that no generated Dart file contains the literal string '{color.'
// (which indicates an unresolved Style Dictionary reference).
//
// Plan 06 (Pipeline Wiring) wires this into the post-build step.
// For now it logs a note and is a no-op.
// ===========================================================================
function runV1UnresolvedRefCheck() {
  console.log(
    '[V1] Post-build reference check deferred to Plan 06 pipeline integration — skipping in pre-build validator.'
  );
  return [];
}
